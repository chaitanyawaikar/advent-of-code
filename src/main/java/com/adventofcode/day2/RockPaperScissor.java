...
public class RockPaperScissor {
    ...
    public long getTotalScoreOfSecondPlayer(String inputFile) {
        List<String> inputData = FileReader.readInputFile(inputFile);

        return inputData
                .stream()
                .mapToInt(this::getScoreFromOutcome)
                .sum();
    }

    @VisibleForTesting
    int getScoreFromOutcome(String inputLine) {
        int totalScore = 0;
    ...
    public static void main(String[] args) {
        ...
        long result = rockPaperScissor.getTotalScoreOfSecondPlayer(INPUT_FILE);
